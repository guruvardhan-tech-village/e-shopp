...
- [~] 1. Configure backend dependencies and project foundation
...
- [ ] 2. Implement domain models and JPA entities
  - [ ] 2.1 Create `User`, `Category`, `Expense`, and `Budget` JPA entity classes under `model/`
  ...
  - [ ] 2.2 Create `DataInitializer` component that seeds the 8 default categories on startup
...
- [ ] 3. Implement JPA repositories
  - [ ] 3.1 Create `UserRepository`, `CategoryRepository`, `ExpenseRepository`, and `BudgetRepository` extending `JpaRepository`
